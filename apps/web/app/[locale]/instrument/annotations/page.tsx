            ...
            {sets.map((a) => (
              <div key={a.id} className="rounded-lg border bg-white p-4 shadow-sm">
                ...
                <div className="mt-1 flex items-center gap-2 text-xs text-slate-600">
                  ...
                  {a.job_id && (
                    <Link href={`/${locale}/instrument/jobs/${a.job_id}`} className="text-blue-400 hover:text-blue-600">↗</Link>
                  )}
                </div>
              </div>
            ))}
            ...
            {sets.map((a) => (
              <div key={a.id} className="grid grid-cols-[80px_100px_140px_100px_1fr_160px_60px] gap-2 border-b px-4 py-3 text-sm last:border-0 items-center">
                ...
                <div className="flex items-center gap-2 text-xs text-slate-600">
                  ...
                  {a.job_id && (
                    <Link href={`/${locale}/instrument/jobs/${a.job_id}`} className="text-blue-400 hover:text-blue-600" title="View job">↗</Link>
                  )}
                </div>
            ...
            <form onSubmit={handleLoadSnapshot} className="space-y-4">
              ...
              {snapResult && (
                <div className="rounded-md border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700">
                  Job queued:{" "}
                  <Link href={`/${locale}/instrument/jobs/${snapResult.id}`} className="font-mono underline hover:text-green-900">
                    {snapResult.id}
                  </Link>
                </div>
              )}
          ...
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleLoadGoa} className="space-y-4">
              ...
              {goaResult && (
                <div className="rounded-md border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700">
                  Job queued:{" "}
                  <Link href={`/${locale}/instrument/jobs/${goaResult.id}`} className="font-mono underline hover:text-green-900">
                    {goaResult.id}
                  </Link>
                </div>
              )}
          ...
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleLoadQuickgo} className="space-y-4">
              ...
              {qgoResult && (
                <div className="rounded-md border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700">
                  Job queued:{" "}
                  <Link href={`/${locale}/instrument/jobs/${qgoResult.id}`} className="font-mono underline hover:text-green-900">
                    {qgoResult.id}
                  </Link>
                </div>
              )}
