      ...
      <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <div className="rounded-lg border border-red-200 bg-red-50 p-6">
            ...
            <Link href={`/${locale}/instrument/datasets`} className="mt-2 inline-block text-sm text-red-700 underline">
              {t("backToList")}
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <header className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              href={`/${locale}/instrument/datasets`}
            ...
            {dataset.job_id && (
              <Link
                href={`/${locale}/instrument/jobs/${dataset.job_id}`}
          ...
          <div className="px-4 py-3 space-y-3 text-sm">
            ...
            {dataset.job_id && (
              <p className="text-xs text-slate-500">
                {t("payloadHint")}{" "}
                <Link href={`/${locale}/instrument/jobs/${dataset.job_id}`} className="text-blue-700 hover:underline">
                  {t("viewJob")}
                </Link>
              </p>
            )}
