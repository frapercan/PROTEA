          ...
          <div className="space-y-3">
            ...
            {pendingJobId && (
              <div className="rounded border border-blue-200 bg-blue-50 px-3 py-2.5 text-sm text-blue-800 flex items-center justify-between gap-3">
                ...
                <a
                  href={`/${locale}/instrument/jobs/${pendingJobId}`}
  ...
  return (
    <div className="px-4 sm:px-8 py-6 sm:py-8 max-w-3xl space-y-8 sm:space-y-10">
      ...
      <ContextBanner
        ...
        prerequisites={[
          { label: `${annotationSets.length} annotation set(s)`, met: annotationSets.length >= 2, href: "/instrument/annotations" },
          { label: `${predictionSets.length} prediction set(s)`, met: predictionSets.length > 0, href: "/instrument/functional-annotation" },
        ]}
        nextStep={{ label: "Scoring configs", href: "/instrument/scoring" }}
      />
