  ...
  const prereqSteps: PrereqStep[] = [
    {
      ...
      emptyHref: `/${locale}/instrument/embeddings`,
    ...
    },
    {
      ...
      emptyHref: `/${locale}/instrument/annotations`,
    ...
    },
    {
      ...
      emptyHref: `/${locale}/instrument/query-sets`,
              ...
              <form onSubmit={handlePredictSubmit} noValidate className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <FieldLabel
                      ...
                      href={`/${locale}/instrument/embeddings`}
                  ...
                  <div>
                    <FieldLabel
                      ...
                      href={`/${locale}/instrument/annotations`}
                      openLabel={t("predictTab.openPage")}
                    />
                    <select
                  ...
                  <div>
                    <FieldLabel
                      ...
                      href={`/${locale}/instrument/query-sets`}
                      openLabel={t("predictTab.openPage")}
                    />
                    <select
                ...
                {predResult && (
                  <div className="rounded-md border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700">
                    Job queued:{" "}
                    <Link href={`/${locale}/instrument/jobs/${predResult.id}`} className="font-mono underline hover:text-green-900">
                      {predResult.id}
                    </Link>
                  </div>
                )}
                ...
                {predictionSets.map((ps) => (
                  <div key={ps.id} className="rounded-lg border bg-white p-3 shadow-sm">
                    <div className="flex items-start justify-between gap-2">
                      <Link
                        href={`/${locale}/instrument/functional-annotation/${ps.id}`}
                  ...
                  {predictionSets.map((ps) => (
                    ...
                    >
                      <div className="font-mono text-xs">
                        <Link href={`/${locale}/instrument/functional-annotation/${ps.id}`} className="text-blue-600 hover:underline" title={ps.id}>
                          {shortId(ps.id)}…
                        </Link>
                      </div>
