Pre-v227 results (superseded, retained for provenance)
======================================================

.. admonition:: Superseded frame, retained for provenance only (dated 2026-07-10)
   :class: danger
   ...
   page may be quoted as a current PROTEA result; it is kept only so the
   older figures remain traceable.
...
.. seealso::
   ...
   - :doc:`/historical/reproduction_guide`: exact command sequence to
