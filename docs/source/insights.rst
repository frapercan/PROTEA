...
The measurements that decided the served method are NOT here: they are the
argument of :doc:`ablation`, and were filed among these gotchas long enough
that a reader looking for the thesis had to dig through tunnel restarts to
find it.
